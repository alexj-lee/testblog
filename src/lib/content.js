...
export async function getBlogpost(slug) {
	...
	// [APP]     slug: 'attention-across-datapoints',
	// [APP]     author: 'alex',
	// [APP]     description: 'A paper notes summary about Kossen et al. 2022.',
	// [APP]     date: '2022-07-31',
	// [APP]     published: true,
	// [APP]     tags: [ 'ml', 'paper' ],
	// [APP]     youtube: 'https://www.youtube.com/watch?v=zejXBg-2Vpk&list=PLoROMvodv4rNiJRchCzutFw5ItR_Z27CM&index=7',
	// [APP]     link: 'https://arxiv.org/abs/2106.02584',
...
export async function parseMarkdown({ filePath, markdown }) {
	...
	// if (filePath) file.path = filePath; // change the file path if specified
