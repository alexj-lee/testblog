...
<div class="flex flex-col justify-center bg-emerald-50 px-4 dark:bg-gray-900 sm:px-8">
	<Nav />
</div>

<main class="flex flex-col justify-center bg-emerald-50 px-4 dark:bg-gray-900 sm:px-8">
	<slot />
</main>
